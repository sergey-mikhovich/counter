...
import {createAppAsyncThunk} from "../../app/types.ts";
...
export const saveCounterStorageStateThunk = createAppAsyncThunk(
    "counter/saveCounterStorageStateThunk",
    async (value: CounterStorageState) => {
